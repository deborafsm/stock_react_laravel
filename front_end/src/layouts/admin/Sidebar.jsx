...
import { SideData } from "../../layout/Aside/DataAside";
            ...
            <div className="sb-sidenav-menu">
                ...
                <div className="nav">
                    {SideData.filter((item) => item.cName.match("Home")).map(
                        (itemFilterName) => (
                            <div key={itemFilterName.id} disablePadding>

                                <Link className="nav-link" to={itemFilterName.path}>
                                    <div className="sb-nav-link-icon">{itemFilterName.icon}</div>
                                    {itemFilterName.title}
                                </Link>
                            </div>
                        )
                    )}
                    ...
                    <Link className="nav-link collapsed" to="#" data-bs-toggle="collapse"
                        ...
                        Periféricos
                        <div className="sb-sidenav-collapse-arrow"><FaRegSun /></div>
                    </Link>
                    {SideData.filter((item) => item.cName.match("periferico")).map(
                        (itemFilterName) => (
